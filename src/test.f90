program test
    ...
    print*,version_diff(version('1.0.0'), version('2.0.0'))
    print*,version_diff(version('2.0.0'), version('2.1.0'))
    print*,version_diff(version('2.1.0'), version('2.1.1'))
    print*,version_diff(version('1.0.0-alpha'), version('1.0.0'))
    print*,version_diff(version('1.0.0-alpha'), version('1.0.0-alpha.1'))
    print*,version_diff(version('1.0.0-alpha.1'), version('1.0.0-alpha.beta'))
    print*,version_diff(version('1.0.0-alpha.beta'), version('1.0.0-beta'))
    print*,version_diff(version('1.0.0-beta'), version('1.0.0-beta.2'))
    print*,version_diff(version('1.0.0-beta.2'), version('1.0.0-beta.11'))
    print*,version_diff(version('1.0.0-beta.11'), version('1.0.0-rc.1'))
    print*,version_diff(version('1.0.0-rc.1'), version('1.0.0'))
